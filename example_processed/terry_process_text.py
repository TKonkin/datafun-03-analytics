"""
Process a text file to count occurrences of the word "digit" and save the result.
"""
...
def process_text_file():
    """Read a text file, count occurrences of 'digit', and save the result."""
    input_file = pathlib.Path(fetched_folder_name, "iso_characters.txt")
    output_file = pathlib.Path(processed_folder_name, "text_digit_word_count.txt")
    word_to_count: str = "digit"
