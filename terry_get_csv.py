...
and saves it to a local file named bus_innovation.csv in a folder named actual_data.
...
fetched_folder_name = "actual_data"
...
def main():
    ...
    """
    csv_url = 'https://www.stats.govt.nz/assets/Uploads/Business-operations-survey/Business-operations-survey-2023/Download-data/business-operations-survey-2023-innovation.csv'
    logger.info("Starting CSV fetch demonstration...")
    fetch_csv_file(fetched_folder_name, "bus_innovation.csv", csv_url)
