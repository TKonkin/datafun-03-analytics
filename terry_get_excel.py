...
and saves it to a local file named pool_sales.xlsx in a folder named actual_data.
...
def main():
    ...
    """
    excel_url = 'https://github.com/shadsluiter/ExcelExamples/raw/refs/heads/master/CrystalPools.xlsx'
    logger.info("Starting Excel fetch demonstration...")
    fetch_excel_file(fetched_folder_name, "pool_sales.xlsx", excel_url)
