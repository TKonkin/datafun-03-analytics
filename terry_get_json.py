"""
This example file fetches JSON data of nobel laureates 
from the web and saves it to a local file named actual_data/laureates.json.
...
def main():
    ...
    """
    json_url = 'https://api.nobelprize.org/v1/laureate.json'
    logger.info("Starting JSON fetch demonstration...")
    fetch_json_file(fetched_folder_name, "laureates.json", json_url)
